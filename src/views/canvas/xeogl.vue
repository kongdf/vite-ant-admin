...
<script setup>
  ...
  import {
    OrbitControls
  } from 'three/examples/jsm/controls/OrbitControls.js' // 对场景进行控制 缩放 平移 旋转 等
  import {
    GLTFLoader
  } from 'three/examples/jsm/loaders/GLTFLoader' // 用于加载3D模型
  //车身颜色数组
  const colorAry = [
    "rgb(216, 27, 67)", "rgb(142, 36, 170)", "rgb(81, 45, 168)", "rgb(48, 63, 159)", "rgb(30, 136, 229)",
    "rgb(0, 137, 123)",
    "rgb(67, 160, 71)", "rgb(251, 192, 45)", "rgb(245, 124, 0)", "rgb(230, 74, 25)", "rgb(233, 30, 78)",
    "rgb(156, 39, 176)",
    "rgb(0, 0, 0)"
  ] // 车身颜色数组
  ...
  const setScene = () => {
    ...
    renderer.setSize(innerWidth-300, innerHeight-200)
